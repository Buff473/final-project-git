...
<div className="rounded-3xl font-medium bg-white text-lg h-10 w-40 m-auto">
  ...
  <div className='flex'>
    ...
    <div className='float-right mt-10'><h1 className='font-bold text-xl'>Spice Taxi & Tours</h1> <p className='text-white'>We are a professional Taxi service. Our services range from airport transfers to island tours.</p></div>
